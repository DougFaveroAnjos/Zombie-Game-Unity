...
public class ControlaZumbi : MonoBehaviour
{
    ...
    void AtacaJogador()
    {
        ...
        Time.timeScale = 0;
        // Acessa o componente "ControlaJogador" na vari�vel p�blica Player e define o textoGameOver do componente como ativo 
        Player.GetComponent<ControlaJogador>().textoGameOver.SetActive(true);
        // Define a vari�vel "Vivo" do jogador como "False"
        Player.GetComponent<ControlaJogador>().Vivo = false;
    }
}
